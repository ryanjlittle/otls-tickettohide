...
class MasterSecretTrustedParty(TrustedParty):
    ...
    def compute(self) -> None:
        ...
        cats = derive_secret(hash_alg, real_secret, b'c hs traffic', hash_val)
        ...
        sats = derive_secret(hash_alg, real_secret, b's hs traffic', hash_val)
        skey = hkdf_expand_label(hash_alg, sats, b'key', b'', cipher.key_length)
        siv = hkdf_expand_label(hash_alg, sats, b'key', b'', cipher.iv_length)
